...
import com.yang.chengquiz.mapper.AppMapper;
import com.yang.chengquiz.model.dto.app.AppQueryRequest;
import com.yang.chengquiz.model.entity.App;
import com.yang.chengquiz.model.entity.User;
import com.yang.chengquiz.model.enums.AppScoringStrategyEnum;
import com.yang.chengquiz.model.enums.AppTypeEnum;
import com.yang.chengquiz.model.enums.ReviewStatusEnum;
import com.yang.chengquiz.model.vo.AppVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (StringUtils.isNotBlank(appName)) {
            // 补充修改校验规则
            ThrowUtils.throwIf(appName.length() > 40, ErrorCode.PARAMS_ERROR, "应用名长度不能超过40");
            ThrowUtils.throwIf(appName.length() < 2, ErrorCode.PARAMS_ERROR, "应用名长度不能小于2");
        }
