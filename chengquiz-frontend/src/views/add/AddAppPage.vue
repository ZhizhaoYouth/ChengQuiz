<template>
  <div id="addAppPage" style="text-align: center">
    ...
    >
      ...
      <p v-if="unSupported" style="color: crimson">
        暂不支持得分类应用的AI评分！
      </p>
      <a-button
        type="primary"
...
const unSupported = computed(() => {
  return form.value.appType === 0 && form.value.scoringStrategy === 1
    ? true
    : false;
});

const appBiz = "app_icon";
